...
with open("vstup.txt", "r", encoding="utf-8") as f:
    vstupni_text4 = ''.join('\u200B' + radek for radek in f)

upraveny_text=replace_newlines_with_backslash(vstupni_text4)
upraveny_text=upraveny_text.replace('\t', r'')
upraveny_text=upraveny_text.replace('#', r'\\')



vstupni_text4=vstupni_text4.replace('(','(\u200B')
vstupni_text4=vstupni_text4.replace('[','(\u200B')
vstupni_text4=vstupni_text4.replace('\t','\u200B')  #tabulátor je nucené rozdělení slova na slabiky
vstupni_text4=vstupni_text4.replace('\n',' xcx ')   #konce odstavce
vstupni_text4=vstupni_text4.replace('#',' xbx ')    # # je konec řadku bez konce odstavce
vstupni_text4=vstupni_text4.replace('-','\u2013')    # # je konec řadku bez konce odstavce
#print(ascii(vstupni_text4))

vstupni_text5 = rozdel_vetu_na_slabiky_tex(vstupni_text4)
#print(ascii(vstupni_text5))
vstupni_text5=vstupni_text5.replace(' \u200bxcx\u200b \u200b','\\') #konce odstavce
vstupni_text5=vstupni_text5.replace(' \u200bxcx','\\') #konec odstavce na konci dokumentu
 
vstupni_text5=vstupni_text5.replace(' \u200bxbx\u200b \u200b','#')  # # je konec řadku bez konce odstavce
vstupni_text5=vstupni_text5.replace(' \u200bxbx','#')  # # je konec řadku bez konce odstavce na konci dokumentu
#print(ascii(vstupni_text5))

# Nahradit dve samohlasky za sebou např "iu" za "i​\u200Bu"  evangelium

for sprezka, nahrazeni in sprezky_samohlasek.items():
    vstupni_text5 = vstupni_text5.replace(sprezka, nahrazeni)
#

unicode_string = text_to_unicode(vstupni_text5, cestina_tengvar)
